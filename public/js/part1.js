...
$(document).on('ready', function() {
	...
	$('#newProBt').click(function(){
		...
		reset();
		showHomePanel();
		$('#user1wrap').append("<span class=\"fa fa-check\">&nbsp;&nbsp;</span><p>New product: " + obj.pro_name + "</p>");
		return false;
	});
